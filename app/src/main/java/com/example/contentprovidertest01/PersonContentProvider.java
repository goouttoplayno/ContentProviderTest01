...
public class PersonContentProvider extends ContentProvider {
    ...
    private static final int PERSON = 1;//操作但行记录
    private static final int PERSONS = 2;//操作多行记录

    //往UriMatcher中添加匹配规则。
    static {
        //添加两个URI筛选
        URI_MATCHER.addURI("com.example.contentprovidertest01.PersonContentProvider", "person", PERSONS);
        //使用通配符#匹配任意数字
        URI_MATCHER.addURI("com.example.contentprovidertest01.PersonContentProvider", "person/#", PERSON);
    }
